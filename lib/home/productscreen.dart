...
class ProductPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller =
        Get.put(myControllerproduct()); // Create and put controller
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            icon:
                const Icon(Icons.arrow_back_rounded, color: Color(0xFF20005E)),
            onPressed: () {
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Obx(() => Text(
                                      controller.counterPcs.value.toString(),
                                      style: TextStyle(
                                          fontSize: 18,
                                          fontFamily: "Poppins",
                                          color: Color(0xFF20005E)))),
                      ...
                      Row(
                        children: [
                          Row(children: [
                            ...
                            Icon(Icons.star,
                                color: Color(0xFFFFD505), size: 18),
                            Icon(
                              Icons.star,
                              color: Color(0xFFFFD505),
                              size: 18,
                ...
                Obx(() => GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              controller.carticon.value,
                              color: Colors.white,
                            ),
                            Text(
                              controller.cartbutton.value,
                              style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white,
