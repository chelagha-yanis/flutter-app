...
import 'package:appstor/home/productscreen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: Drawer(
        ...
        child: Column(
          children: [
            ...
            SwitchListTile(
              secondary:
                  const Icon(Icons.wb_sunny_outlined, color: Color(0xFF20005E)),
              title: const Text(
                "Dark Mode",
                style: TextStyle(
            ...
            ListTile(
              leading: const Icon(Icons.person, color: Color(0xFF20005E)),
              title: const Text(
                "Account",
                style: TextStyle(
                    color: Color(0xFF20005E),
            ...
            ListTile(
              leading:
                  const Icon(Icons.shopping_basket, color: Color(0xFF20005E)),
              title: const Text(
                "Orders",
                style: TextStyle(
                    color: Color(0xFF20005E),
            ...
            ListTile(
              leading: const Icon(Icons.favorite, color: Color(0xFF20005E)),
              title: const Text(
                "Favorites",
                style: TextStyle(
                    color: Color(0xFF20005E),
            ...
            ListTile(
              leading: const Icon(Icons.settings, color: Color(0xFF20005E)),
              title: const Text(
                "Settings",
                style: TextStyle(
                    color: Color(0xFF20005E),
      ...
      appBar: AppBar(
        ...
        // actions: [
        //   IconButton(
        //       icon: const Icon(Icons.shopping_cart, color: Color(0xFF20005E)),
        //       onPressed: () {
        ...
        //       style: ButtonStyle(
        //         backgroundColor:
        //             MaterialStateProperty.all<Color>(const Color(0xFFF7FAFF)),
        //       )),
        //   const SizedBox(
        //     width: 10,
        //   )
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      style: ButtonStyle(
                        ...
                        backgroundColor:
                            MaterialStateProperty.all<Color>(Color(0xFF20005E)),
                      ),
                    ),
                    const SizedBox(
                      width: 10,
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => ProductPage(
                            image: "images/pizzatransparent.png",
                            title: "Pizza",
                            price: "150 DA",
                            description:
                    ...
                    child: ProductCard(
                        "images/pizza.jpeg", "Pizza", "150 DA", "250 DA")),
                SizedBox(
                  width: 20,
                ),
                GestureDetector(
                    onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => ProductPage(
                            ...
                            price: "5 DA",
                            description:
                                "It's a bread and this is just a description so don't read it it has no meaning I'm just trying to make it long enough to fit some space.",
                          ),
                        )),
                    child: ProductCard(
                        "images/baguettes.jpg", "Bread", "5 DA", "10 DA")),
              ],
            ),
            const SizedBox(
              height: 20,
...
class myController extends GetxController {
  ...
  var addBg = const Color.fromARGB(255, 255, 162, 57).obs;
  void toggle() {
